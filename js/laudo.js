...
const EXAMES = [
  {
    ...
    medidas: {
      ...
      observacao:
        "Incluídas apenas as medidas numéricas e parâmetros globais legíveis com segurança no exame fornecido.",
    },
    laudo: {
      descricao: [
        {
          sub: "OLHO DIREITO",
          texto:
            "Índices de confiabilidade adequados, com perdas de fixação de 0/11, falsos positivos de 9% e falsos negativos de 10%. Sensibilidade foveal de 37 dB. GHT dentro dos limites da normalidade. VFI: 99%. MD: -2.05 dB. PSD: 1.59 dB. Mapas de desvio total e padrão demonstram discretas alterações localizadas sem padrão glaucomatoso típico estabelecido.",
        },
        {
          sub: "OLHO ESQUERDO",
          texto:
            "Índices de confiabilidade adequados, com perdas de fixação de 0/10, falsos positivos de 8% e ausência de falsos negativos. Sensibilidade foveal de 37 dB. GHT fora dos limites da normalidade. VFI: 98%. MD: -1.06 dB. PSD: 1.57 dB. Mapas de desvio total e padrão demonstram pequenos defeitos localizados paracentrais, sem perda difusa significativa.",
        },
      ],
      conclusao:
        "Exame confiável em ambos os olhos. Olho direito sem alterações significativas. Olho esquerdo apresenta discretas alterações localizadas, com GHT fora dos limites da normalidade, recomendando correlação clínica e seguimento evolutivo.",
      observacao:
        "A interpretação adequada do exame deve ser realizada em conjunto com os dados clínicos, pressão intraocular, avaliação estrutural do nervo óptico e demais exames complementares.",
    },
  },

  {
    ...
    medidas: {
      tabela: [
        ...
        {
          medida: "RNFL - Temporal Superior (TS)",
          od: "166 µm (ref. 134 µm)",
          os: "171 µm (ref. 134 µm)",
        },
        {
          medida: "RNFL - Nasal Superior (NS)",
          od: "126 µm (ref. 102 µm)",
          os: "154 µm (ref. 102 µm)",
        },
        {
          medida: "RNFL - Nasal (N)",
          od: "99 µm (ref. 72 µm)",
        ...
        {
          medida: "RNFL - Nasal Inferior (NI)",
          od: "129 µm (ref. 105 µm)",
          os: "110 µm (ref. 105 µm)",
        },
        {
          medida: "RNFL - Temporal Inferior (TI)",
          od: "179 µm (ref. 141 µm)",
          os: "160 µm (ref. 141 µm)",
        },
        {
          medida: "RNFL - Temporal (T)",
          od: "68 µm (ref. 74 µm)",
          os: "64 µm (ref. 74 µm)",
        },
        {
      ...
      descricao: [
        {
          sub: "OLHO DIREITO",
          texto:
            "Espessura média global da camada de fibras nervosas de 117 µm, dentro dos limites da normalidade. Setores quadrantais: Superior 146 µm, Inferior 154 µm, Nasal 99 µm e Temporal 68 µm. Curva TSNIT preservada, sem afinamentos focais significativos. Análise setorial demonstrando quadrantes dentro dos padrões esperados para a faixa etária. Classificação automática do equipamento: Within Normal Limits.",
        },
        {
          sub: "OLHO ESQUERDO",
          texto:
            "Espessura média global da camada de fibras nervosas de 115 µm, dentro dos limites da normalidade. Setores quadrantais: Superior 163 µm, Inferior 135 µm, Nasal 98 µm e Temporal 64 µm. Curva TSNIT preservada, sem defeitos estruturais significativos. Análise setorial sem assimetrias relevantes. Classificação automática do equipamento: Within Normal Limits.",
        },
        {
          sub: "ANÁLISE COMPARATIVA",
          texto:
            "Assimetria interocular global de apenas 3 µm. Maior diferença observada no setor Nasal Superior (-28 µm) e Superior (-17 µm), sem traduzir afinamento clinicamente relevante. Sem evidência de assimetria estrutural significativa entre os olhos.",
        },
      ],
      conclusao:
        "Exame tomográfico da camada de fibras nervosas da retina dentro dos padrões de normalidade em ambos os olhos, sem evidências estruturais sugestivas de neuropatia óptica glaucomatosa.",
      observacao:
        "Os achados devem ser correlacionados com avaliação clínica, pressão intraocular, campimetria computadorizada e acompanhamento oftalmológico.",
    },
  },
      ...
      descricao: [
        {
          sub: "OLHO DIREITO",
          texto:
            "Imagem autofluorescente demonstrando extensa área central de alteração do sinal autofluorescente em região macular, compatível com alterações atróficas do epitélio pigmentar da retina. Áreas periféricas sem alterações significativas evidentes.",
        },
        {
          sub: "OLHO ESQUERDO",
          texto:
            "Padrão semelhante ao olho direito, com extensa alteração autofluorescente central envolvendo a mácula. Sem focos evidentes de hiperautofluorescência ativa periférica.",
        },
        {
          sub: "CONSIDERAÇÃO",
          texto:
            "Achados bilaterais compatíveis com processo degenerativo macular crônico.",
        },
      ],
      conclusao:
        "Autofluorescência evidenciando alterações atróficas maculares bilaterais, compatíveis com comprometimento do epitélio pigmentar da retina. Orienta-se correlação com exames complementares e exame físico.",
      observacao: "",
    },
  },

  {
    ...
    medidas: {
      tabela: [
        ...
        {
          medida: "Scan",
          od: "Radial 12.0 mm - 1024×12",
          os: "Radial 12.0 mm - 1024×12",
        },
      ...
      observacao:
        "Nomenclatura nasal/temporal padronizada considerando a orientação anatômica de cada olho.",
    },
    laudo: {
      descricao: [
        {
          sub: "OLHO DIREITO",
          texto:
            "Meios transparentes. Papila óptica com coloração preservada, limites parcialmente visíveis e sem sinais evidentes de edema. Vasos retinianos de trajeto preservado. Área macular apresentando extensa alteração atrófica/degenerativa central, associada a alterações do epitélio pigmentar da retina, com espessura central ETDRS de 205 µm e espessura média de 198,7 µm. Ausência de hemorragias extensas ou exsudação evidente nas imagens fornecidas.",
        },
        {
          sub: "OLHO ESQUERDO",
          texto:
            "Meios transparentes. Papila óptica sem alterações grosseiras evidentes. Vasos retinianos de trajeto preservado. Área macular com extensa alteração atrófica/degenerativa central, espessura central ETDRS de 214 µm e espessura média de 207,0 µm, padrão semelhante ao olho contralateral. Sem sinais evidentes de neovascularização ativa nas imagens analisadas.",
        },
      ],
      conclusao:
        "Retinografia e OCT macular demonstrando alterações maculares bilaterais de padrão atrófico/degenerativo, com comprometimento central em ambos os olhos.",
      observacao:
        "Sugere-se correlação com autofluorescência e avaliação clínica especializada.",
    },
  },
      ...
      descricao: [
        {
          sub: "OLHO DIREITO",
          texto:
            "Densidade celular endotelial de 2712 células/mm². Polimegatismo discreto, com coeficiente de variação de 31%. Pleomorfismo preservado, com 69% de células hexagonais. Espessura corneana central de 540 µm. Morfologia endotelial globalmente preservada, sem sinais de guttata ou descompensação corneana.",
        },
        {
          sub: "OLHO ESQUERDO",
          texto:
            "Densidade celular endotelial de 3158 células/mm². Polimegatismo discreto, com coeficiente de variação de 28%. Pleomorfismo preservado, com 70% de células hexagonais. Espessura corneana central de 544 µm. Aspecto morfológico endotelial preservado.",
        },
        {
          sub: "ANÁLISE COMPARATIVA",
          texto:
            "Comparativamente, observa-se densidade celular adequada em ambos os olhos, sem evidências de perda endotelial significativa.",
        },
      ],
      conclusao:
        "Microscopia especular evidenciando endotélio corneano preservado bilateralmente, com densidade celular adequada e sem sinais de insuficiência endotelial.",
      observacao:
        "Os achados devem ser correlacionados com a avaliação clínica, biomicroscopia e demais exames complementares.",
    },
  },
];
...
function htmlTabelaMedidas(med) {
  ...
  const linhasPrincipais = med.tabela
    .map(
      (r) => `
  ...
  const extras = (med.extras || [])
    .map((ex) => {
      ...
      const trs = ex.linhas
        .map(
          (l) =>
            `<tr>${l.map((v, i) => (i === 0 ? `<th scope="row">${v}</th>` : `<td>${v}</td>`)).join("")}</tr>`,
        )
        .join("");
      return `
  ...
  const obs = med.observacao
    ? `<p class="medidas-obs"><strong>Observação:</strong> ${med.observacao}</p>`
    : "";
...
function htmlLaudoCompleto(exame) {
  const l = exame.laudo;
  const blocos = l.descricao
    .map((d) => `<h4>${d.sub}</h4><p>${d.texto}</p>`)
    .join("");
...
function medidasToText(exame) {
  ...
  if (!m) {
    out += "Exame qualitativo — sem medidas numéricas extraídas.";
    return out;
  }
  out += "Medida\tOD\tOS\n";
...
function renderPaginadorThumb() {
  ...
  wrap.querySelectorAll("[data-pg-act]").forEach((b) => {
    b.addEventListener("click", (e) => {
      ...
      _paginaThumb =
        (_paginaThumb + dir + ex.paginas.length) % ex.paginas.length;
...
async function mostrarLaudo(id) {
  ...
  document.querySelectorAll(".btn-copy[data-copy]").forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      const texto =
        tipo === "medidas" ? medidasToText(exame) : laudoToText(exame);
...
function abrirImagemExame(exameId) {
  ...
  modal.querySelectorAll("[data-pg-act]").forEach((b) => {
    b.addEventListener("click", (e) => {
      ...
      modal.querySelector("#modal-pg-info").textContent =
        _paginaModal + 1 + " / " + total;
    });
  });
    ...
    t.addEventListener("click", () => {
      ...
      modal
        ...
        .forEach((x) =>
          x.setAttribute(
            "aria-selected",
            x.dataset.mtab === nome ? "true" : "false",
          ),
        );
      modal
        .querySelectorAll("[data-mtab-panel]")
        .forEach((p) => (p.hidden = p.dataset.mtabPanel !== nome));
    });
  });
